import {
  BlockLocation, BlockRaycastOptions, Enchantment, Items, ItemStack, Location, MinecraftBlockTypes, MinecraftEnchantmentTypes, Vector, world
...
export class LootChest {
  ...
  static summon(xz, zx, loot, rdrad) {
    ...
    while (!block && C < 150) {
      ...
      if (b && b.location.y >= 50) {block = b.dimension.getBlock(new BlockLocation(b.location.x, b.location.y+1, b.location.z)); break;}
    }
